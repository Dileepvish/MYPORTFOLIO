...
const socials = [
  ...
  { Icon: FaLinkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/dileep-vishwakarma-24559234a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
  { Icon: FaGithub, label: "Github", href: "https://github.com/Dileepvish" },
];
...
export default function Home() {
  const roles = useMemo(() => ["Frontend Developer", "React Developer"], []);
    ...
    >
      ...
      <div className="absolute inset-0">
        <div
          ...
          max-w-lg max-h-lg
          rounded-full
          bg-linear-to-r from-[#302b63] via-[#00bf8f] to-[#1cd8b2]
        ...
        <div className="flex flex-col justify-center h-full text-center lg:text-left">
          <div className="w-full lg:pr-24 mx-auto max-w-3xl">
            ...
            >
              ...
              <span
                className="inline-block ml-1 bg-white animate-pulse align-middle w-px"
                style={{ height: "1em" }}
              ></span>
            </motion.div>
            ...
            >
              Crafting seamless, dynamic web experiences with React and cutting-edge frontend technologies.
            </motion.p>
            ...
            >
              <a
                ...
                className="px-6 py-3 rounded-full font-medium text-lg text-white
                        bg-linear-to-r to-[#1cd8b2] via-[#00bf8f]  from-[#302b63] 
        ...
        <div className="relative hidden lg:block">
          <div
            ...
            style={{
              ...
              opacity: 0.32,
              background:
                "conic-gradient(from 0deg, #1cd8d2, #302b63, #1cd8d2)",
            }}
          />
          <motion.img
            src={avator}
            alt="Dileep Vishwakarma"
